...
export function createThemeStyle(prospect: ResolvedProspect): CSSVariableStyle {
  ...
  return {
    ...
    "--commercial-surface-base": theme.commercialSurfaceBase,
    "--commercial-surface-panel": theme.commercialSurfacePanel,
    "--commercial-surface-elevated": theme.commercialSurfaceElevated,
    "--commercial-surface-highlight": theme.commercialSurfaceHighlight,
    "--commercial-surface-solid": theme.commercialSurfaceSolid,
    "--gold-primary": theme.goldPrimary,
    "--gold-muted": theme.goldMuted,
    "--gold-border": theme.goldBorder,
    "--gold-foreground": theme.goldForeground,
